...
datePicker("30","Nov","2023");
// 2.9.Enter Qty "1” using Select class.
String string = Keys.CONTROL + "a";
sendTextToElement(By.xpath("//input[@id='input-quantity']"),string);
...
verifyTheStringMessage(By.xpath("//table[@class = 'table table-bordered']//small[1]"), "Delivery Date:2023-11-30");
